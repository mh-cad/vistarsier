    ...
    public class DicomNodeRepository : IDicomNodeRepository
    {
        ...
        public IQueryable<DicomNode> GetAll()
        {
            return new List<DicomNode>
            {
                ...
                new DicomNode { LogicalName = "CAPI Server", AeTitle = "VTAIO", IpAddress = "172.28.43.65", Port = 104 },
                new DicomNode { LogicalName = "Synapse", AeTitle = "RMHSYNSCP", IpAddress = "172.28.40.151", Port = 104 },
                new DicomNode { LogicalName = "Syn Mini", AeTitle = "RMHSYNMINISCP", IpAddress = "172.28.40.152", Port = 104 }
            }.AsQueryable();
        }
