...
{
    public class JobOld<T> : IJobOld<T>
    {
        ...
        public JobOld(IJobManagerFactory jobManagerFactory, IDicomFactory dicomFactory,
        ...
        public void Run()
        {
            ...
            {
                _log.Error($"JobOld failed for accession [{accession}] ...", ex);
                throw;
            }
        }
        ...
        private void RunExtractBrainSurfaceProcess(IIntegratedProcess integratedProcess)
        {
            ...
            extractBrainSurfaceProcess.Run(this as IJobOld<IRecipe>);
        }
        private void RunRegistrationProcess(IIntegratedProcess integratedProcess)
        {
            ...
            registrationProcess.Run(this as IJobOld<IRecipe>);
        }
        private void RunTakeDifference(IIntegratedProcess integratedProcess)
        {
            ...
            takeDifferenceProcess.Run(this as IJobOld<IRecipe>);
        }
        private void RunColorMap(IIntegratedProcess integratedProcess)
        {
            ...
            colorMapProcess.Run(this as IJobOld<IRecipe>);
        }
